...
const BlogPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1C] text-white">
      {/* ===== Hero Section ===== */}
      <section
        className="relative w-full h-[35vh] flex items-center justify-center bg-cover bg-center"
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1591696205602-2f950c417cb9?auto=format&fit=crop&w=1400&q=80')",
        }}
      >
