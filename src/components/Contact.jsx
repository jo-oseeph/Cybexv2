...
const contactInfo = [
  { icon: Phone, label: 'Phone', value: '+254717378758', href: 'tel:+254717378758' },
  { icon: Mail, label: 'Email', value: 'info@cybextech.co.ke', href: 'mailto:info@cybextech.co.ke' },
                ...
                {contactInfo.map(({ icon: Icon, label, value, href }, i) => (
                  ...
                  >
                    ...
                    <div className="space-y-0.5">
                      ...
                      {href ? (
                        <a href={href} className="text-white text-sm sm:text-base font-medium hover:text-primary-light transition-colors duration-200">
                          {value}
                        </a>
                      ) : (
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="relative group">
                    ...
                    <textarea name="message" value={form.message} onChange={handleChange} placeholder="Tell us about your project..." required rows={5}
